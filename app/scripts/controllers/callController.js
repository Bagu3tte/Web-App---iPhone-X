angular.module('app')
  .controller('CallController', ['$scope', '$state', '$rootScope', '$interval', function ($scope, $state, $rootScrope, $interval) {
    ...
    var checkNumber = function(){
      ...
      var contactMatt = {
        ...
        number: '123456789',
        image: 'https://pbs.twimg.com/profile_images/378800000256481324/1b5f3ebea130df5aba170c2ed1ef8872.jpeg',
        desc: 'Los Santos'
      };
